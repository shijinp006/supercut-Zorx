              ...
              return (
                <div
                  ...
                  className={`absolute -translate-x-1/2 -translate-y-full z-10 cursor-pointer group ${
                    office.mobileHidden ? "hidden md:block" : "block"
                  }`}
                ...
                >
                  ...
                  <div
                    className={`absolute bottom-[118%] ${
                      isLeftEdge
                        ? "left-0 sm:left-1/2 sm:-translate-x-1/2"
                        : isRightEdge
                        ? "right-0 sm:right-auto sm:left-1/2 sm:-translate-x-1/2"
                        : "left-1/2 -translate-x-1/2"
                    } bg-[#0c1f38] text-white text-xs px-2.5 sm:px-3.5 py-1.5 sm:py-2 rounded-lg shadow-2xl whitespace-nowrap transition-all duration-150 pointer-events-none z-30 ${
                  ...
                  >
                    ...
                    <div
                      className={`w-2 h-2 bg-[#0c1f38] rotate-45 absolute -bottom-1 ${
                        isLeftEdge
